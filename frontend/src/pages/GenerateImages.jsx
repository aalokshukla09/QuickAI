  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form action="" className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200' onSubmit={onsubmitHandler}>
        ...
        <textarea value={input} type="text" className='w-full p-2 border border-gray-300 rounded-md' 
        ...
        <div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
          ...
          {imagestyle.map((item) => {
            return (
              <span key={item} className={`text-xs px-4 py-1 border rounded-full cursor-pointer 
...
text-gray-400'>
            ...
            <p>Enter the description and click "Generate Image" to get Image</p>
          </div>
        </div>):(
